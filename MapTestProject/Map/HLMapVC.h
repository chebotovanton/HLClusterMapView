...
#import "HLListVC.h"
#import "HLCommonResultsVC.h"
#import "ADClusterMapView.h"

@class HLSearchInfo;

@interface HLMapVC : HLCommonVC <HLHotelCalloutProtocol, HLGroupCalloutProtocol, HLResultsVCDelegate, ADClusterMapViewDelegate>
...
@property (nonatomic, weak) id<HLResultsViewControllerProtocol> resultsControllerDelegate;
